...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        def create_link_collection(self, linkagecoll, namecoll):
            """Given function is used to create the link collection.

            This function links together the neo and it's approaches
            """
            for approach in self._approaches:
                for neo in self._neos:
                    if neo.designation == approach.designation:
                        ...
                        if neo.designation not in linkagecoll.keys():
                            linkagecoll[neo.designation] = []
                            linkagecoll[neo.designation].append(approach)
                            break
                        else:
                            linkagecoll[neo.designation].append(approach)
                            break
            for neo in neos:
                if neo.name not in namecoll.keys():
                    namecoll[neo.name] = neo.designation
            return (linkagecoll, namecoll)

        self.linkagecoll = {}
        self.namecoll = {}
        (self.linkagecoll, self.namecoll) = create_link_collection(self,
        self.linkagecoll, self.namecoll)
    ...
    def get_neo_by_designation(self, designation):
        ...
        """
        try:
            return self.linkagecoll[designation][0].neo
        except KeyError:
            return None
    ...
    def get_neo_by_name(self, name):
        ...
        """
        try:
            return self.linkagecoll[self.namecoll[name]][0].neo
        except KeyError:
            return None
    ...
    def query(self, filters=()):
        ...
        """
        for approach in self._approaches:
            tc = list(map(lambda fo: fo(approach), filters))
            if False not in tc:
                yield approach
